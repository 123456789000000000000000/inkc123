...
public class InkcRegisterDogShowActivity extends AppCompatActivity {
    ...
    AdapterClassInkcRegisterDog adapterClassInkcRegisterDog;
    private AdapterClassInkcRegisterDog.RecycleViewClickListener listener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inkc_register_dog_show);
    ...
    private void initialize(Bundle _savedInstanceState) {
        ...
        adapterClassInkcRegisterDog = new AdapterClassInkcRegisterDog(listener,datalist,InkcRegisterDogShowActivity.this);
    ...
    private void recycleClickLister() {
        listener = new AdapterClassInkcRegisterDog.RecycleViewClickListener() {
            @Override
...
//                Toast.makeText(InkcRegisterDogShowActivity.this, kk, Toast.LENGTH_SHORT).show();
            }
        };
    }

    private void fetchdata() {
        progressDialog  = new ProgressDialog(InkcRegisterDogShowActivity.this);
        progressDialog.setMessage("Please Wait...");
        progressDialog.show();

        appConfig = new AppConfig(InkcRegisterDogShowActivity.this);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, inkcregisterurl,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (data.equals("false")) {
                                ...
                                Toast.makeText(InkcRegisterDogShowActivity.this, "Data is not available", Toast.LENGTH_SHORT).show();
                                progressDialog.dismiss();
                            }else {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(InkcRegisterDogShowActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(InkcRegisterDogShowActivity.this);
