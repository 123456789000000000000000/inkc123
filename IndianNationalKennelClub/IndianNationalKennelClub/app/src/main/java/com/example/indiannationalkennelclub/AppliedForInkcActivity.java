...
public class AppliedForInkcActivity extends AppCompatActivity {

    RecyclerView recyclerView;
    String inkcregisterurl = "https://test181120221003.inkc.in/api/dog/inkc_kci_registered_dog";
    ProgressDialog progressDialog;
    List<ResponseModelInkcRegisterDog> datalist;
    AppConfig appConfig;
    LinearLayoutManager linearLayoutManager;
    ResponseModelInkcRegisterDog responseModelInkcRegisterDog;
    AdapterClassAppliedForInkc adapterClassInkcRegisterDog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_applied_for_inkc);
    ...
    private void initialize(Bundle savedInstanceState) {
        ...
        adapterClassInkcRegisterDog = new AdapterClassAppliedForInkc(listener,datalist,AppliedForInkcActivity.this);
        recyclerView.setAdapter(adapterClassInkcRegisterDog);
    ...
    private void recycleClickLister() {
        listener = new AdapterClassAppliedForInkc.RecycleViewClickListener() {
            @Override
            public void onClick(View v, int position) {

                AlertDialog.Builder alertDialog = new AlertDialog.Builder(AppliedForInkcActivity.this);
                final View customLayout = getLayoutInflater().inflate(R.layout.dialog_applied_for_not_pay_fee, null);
...
//                Toast.makeText(AppliedForInkcActivity.this, kk, Toast.LENGTH_SHORT).show();
            }
        };
    }

    private void fetchdata() {
        progressDialog  = new ProgressDialog(AppliedForInkcActivity.this);
        progressDialog.setMessage("Please Wait...");
        progressDialog.show();

        appConfig = new AppConfig(AppliedForInkcActivity.this);
        String token = appConfig.getuser_token();
        String userId = appConfig.getInkcRegis();

        StringRequest request = new StringRequest(Request.Method.POST, inkcregisterurl,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (data.equals("false")) {
                                ...
                                Toast.makeText(AppliedForInkcActivity.this, "Data is not available", Toast.LENGTH_SHORT).show();
                                progressDialog.dismiss();
                            }else {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    String transfer_pet_id = object.getString("transfer_pet_id");
                                    if(pet_checked.equals("1")) {
                                    }
                                    else{

                                        responseModelInkcRegisterDog = new ResponseModelInkcRegisterDog(pet_id, owner_id, is_second_owner, second_owner_id, litter_kennel_id, is_non_inkc_registration, pet_name, implemented_date, birth_date, pet_category_id, pet_sub_category_id, is_microchip_require, pet_microchip_number, upload_microchip_document, is_document_require, pet_registration_number, sire_reg_number, sire_user_approval, sire_user_approval_comment,
                                                sire_admin_approval, sire_admin_approval_comment, dam_reg_number, dam_user_approval, dam_user_approval_comment, dam_admin_approval, dam_admin_approval_comment, implement_by, implementer_name, implementer_mobile_number, microchip_status, pet_gender, color_marking, pet_image, front_side_certificate, back_side_certificate, pet_height_image, pet_side_image, document_upload, pet_comment, is_transfer_changed_name, pet_updated_on, pet_created_on, pet_registered_as, pet_checked,
                                                pet_status, is_paid_for_pet, user_full_name, category_name, sub_category_name, transfer_pet_id);
                                        datalist.add(responseModelInkcRegisterDog);
                                        adapterClassInkcRegisterDog.notifyDataSetChanged();
                                        progressDialog.dismiss();
                                    }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(AppliedForInkcActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(AppliedForInkcActivity.this);
