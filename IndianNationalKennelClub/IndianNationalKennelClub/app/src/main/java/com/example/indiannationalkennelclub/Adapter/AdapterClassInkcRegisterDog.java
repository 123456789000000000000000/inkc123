...
public class AdapterClassInkcRegisterDog extends RecyclerView.Adapter<AdapterClassInkcRegisterDog.MyViewHolder> {

    private  AdapterClassInkcRegisterDog.RecycleViewClickListener listener;
    List<ResponseModelInkcRegisterDog> data;
    Context context;

    public AdapterClassInkcRegisterDog(RecycleViewClickListener listener, List<ResponseModelInkcRegisterDog> data, Context context) {
        this.listener = listener;
        this.data = data;
        this.context = context;
    }
    //    public AdapterClassInkcRegisterDog(RecycleViewClickListener listener, List<ResponseModelInkcRegisterDog> data) {
//        this.listener = listener;
//        this.data = data;
//    }
