...
public class SelectpuppiesActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		...
		_view(button1, 50, 13, "#40c9a2");
		_view(button2, 50, 13, "#40c9a2");
		_view(button3, 50, 13, "#40c9a2");
		_view(button4, 50, 13, "#40c9a2");
		_view(button5, 50, 13, "#40c9a2");
		_view(button6, 50, 13, "#40c9a2");
		_view(button7, 50, 13, "#40c9a2");
		_view(button8, 50, 13, "#40c9a2");
		_view(button9, 50, 13, "#40c9a2");
		_view(button10, 50, 13, "#40c9a2");
		_view(button11, 50, 13, "#40c9a2");
		_view(button12, 50, 13, "#40c9a2");
		_view(linear6, 50, 0, "#fff8e1");
	}
